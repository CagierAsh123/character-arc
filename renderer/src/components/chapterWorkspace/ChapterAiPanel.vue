...
import { useChapterAi } from '@/composables/useChapterAi'
import { useChapterFirstDraft } from '@/composables/useChapterFirstDraft'
import { useChapterThreadDetect } from '@/composables/useChapterThreadDetect'
import { useChapterSummary } from '@/composables/useChapterSummary'
import { useChapterInspiration, type ChapterInspirationFocus } from '@/composables/useChapterInspiration'
import { useChapterHumanize } from '@/composables/useChapterHumanize'
...
import type { ContextModule } from '@/composables/useChapterAi'
